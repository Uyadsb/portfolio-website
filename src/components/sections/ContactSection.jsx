...
const ContactSection = () => {
  ...
  const contactLinks = [
    { 
      ...
      value: 'hello@koldercreative.com',
    ...
    { 
      name: 'Instagram', 
      href: 'https://instagram.com/koldercreative', 
      value: '@koldercreative',
    ...
    { 
      name: 'TikTok', 
      href: 'https://tiktok.com/@koldercreative', 
      value: '@koldercreative',
  ...
  return (
    <section
      ref={sectionRef}
      id="contact"
      className="pt-10 pb-12 sm:pt-12 sm:pb-16 md:pt-16 md:pb-20 bg-[#0a0a0a] relative overflow-visible"
    >
      <div className="section-container relative z-10">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <p className="text-[#6b6b6b] text-sm sm:text-base">
              Based in <span className="text-white">Los Angeles, California</span> • Available worldwide
            </p>
          </motion.div>
        </div>
        ...
        <motion.footer
          ...
          className="mt-12 sm:mt-16 md:mt-20 pt-6 sm:pt-8 border-t border-[#1f1f1f] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-[#6b6b6b]"
        >
